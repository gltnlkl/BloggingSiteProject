...
//	public boolean  fiveTimesCheckPassword() {
//
//		
//		boolean bool = true;
//		int attempt = 5;
...
//	}
	...
	// UUID (random 16 haneli bir veri olusturur)

	public static UUID uuidMethod() {
	...
	// mesajlari local dosyaya yazdirmak icin
	public static void writeFileIO(String write, String path) {
	...
	// mesajlari local dosyadan okumak icin
	private static void readFileIO(String path) {
